...
public enum Operacao {
	...
	MOV_REG_VAL(1, "MOV_REG_VAL"), MOV_REG_REG(2, "MOV_REG_REG"), MOV_REG_END(3, "MOV_REG_END"), MOV_END_END(4,
			"MOV_END_END"), MOV_END_VAL(5, "MOV_END_VAL"), MOV_END_REG(6, "MOV_END_REG"),

	ADD_END_END(7, "ADD_END_END"), ADD_END_VAL(8, "ADD_END_VAL"), ADD_END_REG(9, "ADD_END_REG"), ADD_REG_VAL(10,
			"ADD_REG_VAL"), ADD_REG_REG(11, "ADD_REG_REG"), ADD_REG_END(12, "ADD_REG_END"),

	INC_REG(13, "INC_REG"), INC_END(14, "INC_END"),

	IMUL_REG_REG(15, "IMUL_REG_REG"), IMUL_REG_REG_VAL(16, "IMUL_REG_REG_VAL"), IMUL_REG_END(17,
			"IMUL_REG_END"), IMUL_REG_END_VAL(18, "IMUL_REG_END_VAL")
